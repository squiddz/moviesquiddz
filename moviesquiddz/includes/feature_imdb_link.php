...
echo '<td><a href="../moviesquiddz/imdbphp/imdbsearch.php?name=' . $movie_name . '&searchtype=movie" ';
?>
onclick="return hs.htmlExpand(this, { objectType: 'ajax', width: '500', headingText: 'IMDb Information', wrapperClassName: 'titlebar' } )">
<img src="../moviesquiddz/images/imdb.png" /></a></td>
